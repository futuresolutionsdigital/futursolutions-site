...
export const resourceFilters = {
	topics: ['Clinical Practice', 'Pharmacology', 'Advocacy', 'Workforce', 'Leadership', 'Preceptorship', 'Career Growth', 'Telehealth', 'Reimbursement', 'Public Health', 'Documentation', 'Education', 'Membership', 'Chapter Tools'],
	types: ['CE Course', 'Webinar', 'Practice Guide', 'Toolkit', 'Policy Brief', 'Template', 'Report', 'FAQ', 'Career Resource', 'Chapter Resource'],
	...
	ce: ['CE eligible', 'No CE', 'On-demand CE', 'Live CE'],
} as const;
...
export const resourceLibraryItems = [
	...
	{ title: 'Policy Brief: Workforce Access Gaps', summary: 'An analysis of workforce shortages, geographic disparities, and policy recommendations for expanding access.', type: 'Policy Brief', topic: 'Workforce', audience: 'Practicing Professionals', access: 'Public', ce: 'No CE', duration: 'Brief', date: 'May 2026', href: '/demos/association/advocacy', featured: false },
	{ title: 'Telehealth Consent Template', summary: 'Customizable patient consent form template for telehealth visits, including state-specific considerations.', type: 'Template', topic: 'Telehealth', audience: 'Practicing Professionals', access: 'Public', ce: 'No CE', duration: 'Template', date: 'March 2026', href: '/demos/association/resources', featured: false },
	{ title: 'Chapter Sponsorship Outreach Template', summary: 'Email and letter templates for chapter leaders seeking local event sponsors and community partners.', type: 'Template', topic: 'Chapter Tools', audience: 'Chapter Leaders', access: 'Member-only', ce: 'No CE', duration: 'Template', date: 'April 2026', href: '/demos/association/resources', featured: false },
	{ title: 'Leadership Roundtable Replay', summary: 'Recorded panel discussion on healthcare leadership, workforce strategy, and building resilient teams.', type: 'Webinar', topic: 'Leadership', audience: 'Clinical Leaders', access: 'Member-only', ce: 'On-demand CE', duration: '75 min', date: 'February 2026', href: '/demos/association/resources', featured: false },
	{ title: 'Rural Practice Resource Packet', summary: 'Guides, templates, and community health tools designed for professionals practicing in rural and underserved areas.', type: 'Toolkit', topic: 'Public Health', audience: 'Practicing Professionals', access: 'Public', ce: 'No CE', duration: 'Packet', date: 'January 2026', href: '/demos/association/resources', featured: false },
	{ title: 'CE Certificate Claiming Guide', summary: 'How to access, download, and submit CE certificates from MHPA-accredited courses and events.', type: 'FAQ', topic: 'Education', audience: 'Practicing Professionals', access: 'Public', ce: 'No CE', duration: 'Quick Reference', date: 'May 2026', href: '/demos/association/resources', featured: false },
	{ title: 'Legislative Testimony Preparation Kit', summary: 'A toolkit for preparing written and oral testimony for state legislative hearings on healthcare issues.', type: 'Toolkit', topic: 'Advocacy', audience: 'Practicing Professionals', access: 'Public', ce: 'No CE', duration: 'Kit', date: 'April 2026', href: '/demos/association/advocacy#toolkit', featured: false },
	{ title: 'Member Benefits Quick Reference', summary: 'A one-page overview of MHPA membership benefits, including education, advocacy, career, and chapter resources.', type: 'FAQ', topic: 'Membership', audience: 'New Professionals', access: 'Public', ce: 'No CE', duration: 'Quick Reference', date: 'January 2026', href: '/demos/association/membership', featured: false },
	{ title: 'Student Transition-to-Practice Guide', summary: 'Practical advice on credentialing, malpractice insurance, first-year expectations, and professional identity.', type: 'Career Resource', topic: 'Career Growth', audience: 'Students', access: 'Public', ce: 'No CE', duration: 'Guide', date: 'March 2026', href: '/demos/association/resources', featured: false },
	{ title: 'Quality Improvement Starter Toolkit', summary: 'PDSA cycles, outcome measurement templates, and root cause analysis worksheets for clinical quality projects.', type: 'Toolkit', topic: 'Clinical Practice', audience: 'Clinical Leaders', access: 'Member-only', ce: 'CE eligible', duration: '2 hours', date: 'February 2026', href: '/demos/association/resources', featured: false },
	{ title: 'Clinical Supervision Conversation Guide', summary: 'Frameworks for productive supervisory conversations covering clinical competency, feedback, and career development.', type: 'Practice Guide', topic: 'Preceptorship', audience: 'Clinical Leaders', access: 'Member-only', ce: 'No CE', duration: 'Guide', date: 'April 2026', href: '/demos/association/resources', featured: false },
	{ title: 'Professional Boundaries in Digital Care', summary: 'Guidance on maintaining professional boundaries in telehealth, messaging, and social media interactions with patients.', type: 'CE Course', topic: 'Telehealth', audience: 'Practicing Professionals', access: 'Member-only', ce: 'CE eligible', duration: '1.5 hours', date: 'May 2026', href: '/demos/association/resources', featured: false },
	{ title: 'Billing Documentation Essentials', summary: 'Documentation requirements, common billing errors, and audit preparation for healthcare billing compliance.', type: 'Practice Guide', topic: 'Reimbursement', audience: 'Practicing Professionals', access: 'Member-only', ce: 'CE eligible', duration: '1 hour', date: 'March 2026', href: '/demos/association/resources', featured: false },
	{ title: 'Public Comment Submission Template', summary: 'A reusable template for submitting public comments on proposed regulations, rules, and policy changes.', type: 'Template', topic: 'Advocacy', audience: 'Practicing Professionals', access: 'Public', ce: 'No CE', duration: 'Template', date: 'February 2026', href: '/demos/association/advocacy', featured: false },
	{ title: 'Local Chapter Event Budget Template', summary: 'Spreadsheet template for planning and tracking chapter event budgets, vendor costs, and sponsorship revenue.', type: 'Template', topic: 'Chapter Tools', audience: 'Chapter Leaders', access: 'Member-only', ce: 'No CE', duration: 'Template', date: 'January 2026', href: '/demos/association/resources', featured: false },
];
...
export const careerFeaturedJobs = [
	...
	{ title: 'Rural Access Program Lead', employer: 'Northern Valley Health Outreach', location: 'Chico, CA', workType: 'On-site', schedule: 'Full-time', salaryRange: '$92,000–$112,000', category: 'Public Health', experienceLevel: 'Senior', postedDate: 'May 3, 2026', summary: 'Design and manage rural healthcare access programs, coordinate mobile clinic operations, and partner with community organizations.', tags: ['rural', 'access', 'leadership'], href: '/demos/association/career-center', featured: false },
	{ title: 'Clinical Documentation Educator', employer: 'Heritage Medical Center', location: 'Los Angeles, CA', workType: 'On-site', schedule: 'Full-time', salaryRange: '$76,000–$92,000', category: 'Education', experienceLevel: 'Mid-career', postedDate: 'May 2, 2026', summary: 'Train clinical staff on documentation standards, EHR optimization, and coding compliance for improved reimbursement accuracy.', tags: ['documentation', 'education', 'compliance'], href: '/demos/association/career-center', featured: false },
	{ title: 'Community Health Program Manager', employer: 'Sunrise Community Wellness Foundation', location: 'Riverside, CA', workType: 'Hybrid', schedule: 'Full-time', salaryRange: '$85,000–$102,000', category: 'Public Health', experienceLevel: 'Mid-career', postedDate: 'May 1, 2026', summary: 'Lead community health initiatives, manage grant-funded programs, and coordinate outreach across diverse populations.', tags: ['community', 'management', 'grants'], href: '/demos/association/career-center', featured: false },
	{ title: 'Quality Improvement Specialist', employer: 'Golden Gate Health Partners', location: 'San Francisco, CA', workType: 'On-site', schedule: 'Full-time', salaryRange: '$82,000–$98,000', category: 'Administration', experienceLevel: 'Mid-career', postedDate: 'Apr 30, 2026', summary: 'Lead PDSA cycles, develop outcome dashboards, and support accreditation readiness across clinical departments.', tags: ['quality', 'improvement', 'accreditation'], href: '/demos/association/career-center', featured: false },
	{ title: 'Student Placement Coordinator', employer: 'California Clinical Education Consortium', location: 'Sacramento, CA', workType: 'Hybrid', schedule: 'Full-time', salaryRange: '$62,000–$75,000', category: 'Preceptorship', experienceLevel: 'Entry', postedDate: 'Apr 29, 2026', summary: 'Manage student clinical placement logistics, preceptor matching, and site compliance documentation.', tags: ['preceptorship', 'students', 'coordination'], href: '/demos/association/career-center', featured: false },
	{ title: 'Advanced Practice Operations Lead', employer: 'Pacific Health System', location: 'San Jose, CA', workType: 'On-site', schedule: 'Full-time', salaryRange: '$105,000–$128,000', category: 'Practice Operations', experienceLevel: 'Senior', postedDate: 'Apr 28, 2026', summary: 'Oversee advanced practice provider operations, credentialing workflows, and productivity benchmarking.', tags: ['operations', 'APP', 'leadership'], href: '/demos/association/career-center', featured: false },
	{ title: 'Regional Clinical Trainer', employer: 'Statewide Health Training Alliance', location: 'Multiple Locations, CA', workType: 'Hybrid', schedule: 'Full-time', salaryRange: '$88,000–$106,000', category: 'Education', experienceLevel: 'Mid-career', postedDate: 'Apr 27, 2026', summary: 'Deliver clinical training across regional sites, develop curricula, and evaluate learner competency outcomes.', tags: ['education', 'training', 'clinical'], href: '/demos/association/career-center', featured: false },
	{ title: 'Care Access Strategy Manager', employer: 'Equity Health Network', location: 'Oakland, CA', workType: 'Hybrid', schedule: 'Full-time', salaryRange: '$98,000–$118,000', category: 'Clinical Leadership', experienceLevel: 'Senior', postedDate: 'Apr 26, 2026', summary: 'Develop strategies to reduce care access barriers, analyze utilization patterns, and partner with community stakeholders.', tags: ['access', 'strategy', 'equity'], href: '/demos/association/career-center', featured: false },
	{ title: 'Policy Research Associate', employer: 'Healthcare Policy Institute of California', location: 'Sacramento, CA', workType: 'Hybrid', schedule: 'Full-time', salaryRange: '$68,000–$82,000', category: 'Policy & Advocacy', experienceLevel: 'Entry', postedDate: 'Apr 25, 2026', summary: 'Research healthcare policy issues, draft briefs and testimony, and support legislative tracking and stakeholder engagement.', tags: ['policy', 'research', 'advocacy'], href: '/demos/association/career-center', featured: false },
	{ title: 'Clinical Services Administrator', employer: 'Valley View Medical Group', location: 'Bakersfield, CA', workType: 'On-site', schedule: 'Full-time', salaryRange: '$90,000–$110,000', category: 'Administration', experienceLevel: 'Senior', postedDate: 'Apr 24, 2026', summary: 'Manage clinical department operations, budget oversight, staff scheduling, and regulatory compliance.', tags: ['administration', 'management', 'compliance'], href: '/demos/association/career-center', featured: false },
	{ title: 'Mentorship Program Manager', employer: 'MHPA Chapter Services', location: 'Remote', workType: 'Remote', schedule: 'Part-time', salaryRange: '$55,000–$68,000', category: 'Education', experienceLevel: 'Mid-career', postedDate: 'Apr 23, 2026', summary: 'Coordinate statewide mentorship matching, develop mentor training materials, and track program outcomes.', tags: ['mentorship', 'program', 'remote'], href: '/demos/association/career-center', featured: false },
	{ title: 'Workforce Development Coordinator', employer: 'Central Coast Health Workforce Center', location: 'Santa Barbara, CA', workType: 'On-site', schedule: 'Full-time', salaryRange: '$70,000–$85,000', category: 'Public Health', experienceLevel: 'Mid-career', postedDate: 'Apr 22, 2026', summary: 'Coordinate workforce pipeline programs, manage training grants, and partner with educational institutions.', tags: ['workforce', 'development', 'grants'], href: '/demos/association/career-center', featured: false },
	{ title: 'Integrated Care Program Lead', employer: 'Pinnacle Behavioral Health Alliance', location: 'San Diego, CA', workType: 'Hybrid', schedule: 'Full-time', salaryRange: '$108,000–$130,000', category: 'Clinical Leadership', experienceLevel: 'Senior', postedDate: 'Apr 21, 2026', summary: 'Lead integrated primary care and behavioral health programs, develop care protocols, and supervise clinical teams.', tags: ['integrated', 'behavioral', 'leadership'], href: '/demos/association/career-center', featured: false },
	{ title: 'Employer Partnership Specialist', employer: 'MHPA Career Services', location: 'Remote', workType: 'Remote', schedule: 'Full-time', salaryRange: '$72,000–$88,000', category: 'Administration', experienceLevel: 'Mid-career', postedDate: 'Apr 20, 2026', summary: 'Build and maintain employer partnerships, manage job posting services, and coordinate career fair logistics.', tags: ['employer', 'partnerships', 'career'], href: '/demos/association/career-center', featured: false },
];
