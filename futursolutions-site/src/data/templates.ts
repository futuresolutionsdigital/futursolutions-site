...
export const templateSystems: TemplateSystem[] = [
	{
		...
		salesFaqs: [
			{ q: 'Is this a real med spa?', a: 'No. The demo uses a fictional med spa concept created by FutureSolutions to show how this Website Foundation can look and function for a real aesthetic clinic. All names, treatments, providers, and results are entirely fictional.' },
			{ q: 'Can this be customized for my med spa?', a: 'Yes. Branding, services, colors, photography, provider bios, treatment pages, booking flow, and content can all be customized to match your real clinic.' },
			{ q: 'Can you add more treatment pages?', a: 'Yes. The Botox page is the flagship example, and the same structure can be expanded for fillers, Morpheus8, IPL, Hydrafacial, laser hair removal, body contouring, medical weight loss, and more.' },
			{ q: 'Can this connect to online booking or GoHighLevel?', a: 'Yes. The consultation form and CTAs can be connected to GoHighLevel, CRM tools, booking software, email notifications, or automation workflows.' },
			{ q: 'Can this support SEO?', a: 'Yes. The page structure supports treatment pages, service categories, FAQs, local content, location pages, and blog/resource expansion for organic search visibility.' },
			{ q: 'Is this only for luxury med spas?', a: 'No. The visual direction is premium, but it can be adapted for boutique clinics, injectables studios, wellness-focused med spas, laser clinics, or cosmetic dermatology practices.' },
		],
	},
	{
		slug: 'solo-practice',
		...
		salesFaqs: [
			{ q: 'Can this be customized for my practice?', a: 'Yes. Everything — the provider name, services, pricing, branding, photography, and copy — can be adapted to match your real practice. The demo is a starting point, not a finished product.' },
			{ q: 'Can this work for a solo NP or solo physician?', a: 'Absolutely. The Foundation was designed specifically for single-provider practices. The provider-led homepage, about page, and care model explainer all center one person\'s story and expertise.' },
			{ q: 'Can you connect real booking and forms?', a: 'Yes. The demo includes placeholder forms that are structured for easy connection to scheduling platforms (Jane App, Calendly, Acuity) or CRM systems like GoHighLevel.' },
			{ q: 'Can the services and pricing be changed?', a: 'Completely. You can add, remove, or rename services. Pricing tiers, visit types, HSA/FSA language, and superbill information are all customizable.' },
			{ q: 'Can this support SEO and blog content?', a: 'Yes. The resource hub, service pages, and condition grid are all structured for organic search visibility. Blog content can be added for ongoing traffic growth.' },
			{ q: 'Is this a real clinic?', a: 'No. Aster Private Health is a fictional demo created for portfolio presentation. All provider names, testimonials, pricing, and patient data are entirely fictional.' },
		],
	},
	{
		slug: 'association',
		...
		salesFaqs: [
			{ q: 'Is this a real association?', a: 'No. The demo uses a fictional association created by FutureSolutions to show how a modern professional association Website Foundation could work. All names, events, policies, and data are entirely fictional.' },
			{ q: 'Can this be customized for my association?', a: 'Yes. The demo brand, page structure, navigation, content, membership tiers, events, resources, chapters, and CTAs can all be adapted to your real organization.' },
			{ q: 'Can this connect to our AMS or CRM?', a: 'Yes. Membership forms and contact routing are structured for association management system connection. CRM integrations can be wired through Growth System setup.' },
			{ q: 'Can we add real events, CE, and a job board?', a: 'Absolutely. Event pages can route to Cvent, Eventbrite, or custom registration. CE catalog structure is ready for LMS integration. Career center pages can connect to employer posting workflows.' },
			{ q: 'Does this support advocacy and policy work?', a: 'Yes. The advocacy landing, policy issue detail, and action alert patterns are built specifically for organizations that need to mobilize members around legislative priorities.' },
			{ q: 'Can this run on a CMS?', a: 'Yes. Resources, events, chapters, jobs, and issues follow structured schemas ready for Sanity, Contentful, or similar headless CMS systems.' },
		],
	},
	{
